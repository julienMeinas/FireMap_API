package com.istl.firemap_api;

import com.istl.firemap_api.bo.Firework;
import com.istl.firemap_api.bo.Fireworker;
import com.istl.firemap_api.bo.Parking;
import com.istl.firemap_api.repository.FireworkRepository;
...
class LoadDatabase {
	...
	CommandLineRunner initDatabase(FireworkRepository repository) {
		...
		return args -> {
			...
			log.info("Preloading " + repository.save(new Firework(1.0007, 90.0008, "Antwerp centre", new Date(), 0, true, 45, "Medium", fireworker2, parkings2)));
		};
	}
}
