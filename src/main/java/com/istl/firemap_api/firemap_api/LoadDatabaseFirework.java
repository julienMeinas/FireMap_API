	...
	CommandLineRunner initDatabase(FireworkRepository repository) throws ParseException {
		...
		return args -> {
			log.info("Preloading " + repository.save(new Firework(3.172488, 50.638002, "Villeneuve d'ascq","Lac du héron", date1, "Il veut le mariage du siècle, des petits fours et un feu d'artifice. Elle, des hamburgers, de l'alcool, à la bonne franquette. Tout doit être parfait ! \n" +
					...
					"Mais qui attrapera le bouquet ?",0, true, "Middle", "High", 1, parkings, avis1, 3.5)));
			log.info("Preloading " + repository.save(new Firework(3.049432, 50.637137, "Lille", "Foire de Lille", new Date(), "Venez admirer une ville transformée aux couleurs de l'amour, plus de 1 000 ballons en forme de cœur habillent le centre-ville. De nombreuses animations divertiront les amoureux !",0, false, "Middle", "Low", 2, parkings1, avis1, 4)));
			...
			log.info("Preloading " + repository.save(new Firework(3.160554, 50.723466, "Tourcoing", "Tourcoing centre", new Date(), "Dégustations, expositions, concerts et feux d'artifice composent le programme de cette grande fête. \n" +
					"\n" +
					"Tous les amoureux du vin, de la gastronomie, de la fête et de la culture sont conviés à partager des moments de liesse et de festivité le long des quais de Garonne : un programme exceptionnel permettant à tous de découvrir la beauté architecturale de la ville, sa richesse culturelle, les vignobles qui l'entourent et les multiples atouts du terroir régional.",0, false, "Short", "Low", 2, parkings3, avis1, 2.5)));
			log.info("Preloading " + repository.save(new Firework(3.118858, 50.645773, "Mons", "Mons", new Date(), "La Ville de Bergheim vous propose un bal champêtre à l'occasion de Fête Nationale française. De nombreuses animations rythmeront la soirée sans oublier le traditionnel feu d'artifice au parking du Jardin de Ville. L'animation est assurée par l'Orchestre Los Festival.",5, true, "Short", "High", 4, parkings4, avis1, 2)));
			log.info("Preloading " + repository.save(new Firework(5.372787, 43.295278, "Marseille", "Marseille", new Date(), "Retraite aux flambeaux, ( rassemblement à la mairie vers 22h ), feu d'artifice et bal au champ de foire, à la tombée de la nuit.",0, false, "Short", "High", 5, parkings5, avis1, 5)));
			log.info("Preloading " + repository.save(new Firework(2.312310, 48.852617, "Paris", "Paris 7e", new Date(), "Grand feu d'artifice sonorisé. \n" +
					"A 22h30, vous partez de la place du Champ de Foire de St André de Cubzac pour vous rendre au stade Léo Lagrange, au son de la cocarde de St Ciers de Canesse. A 23h00, vous admirez le feu d'artifice.",50, true, "Long", "High", 1, parkings6, avis1, 0.5)));
